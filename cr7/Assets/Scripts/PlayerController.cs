...
/// <summary>
/// Simple roll-a-ball player controller using the Unity Input System.
/// Reads a Vector2 from keyboard (WASD + arrows) and sets rb.velocity in FixedUpdate.
/// Attach to the player GameObject (sphere) and make sure it has a Rigidbody.
/// </summary>
